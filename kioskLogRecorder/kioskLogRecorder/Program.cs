...
string path = "C:\\Users\\rgunn\\Desktop\\" + arr[0] + arr[1] + "-" + arr[3] + "-" + arr[7] + arr[8]  + ".txt";//MAKE SURE YOUR USERNAME IS USED.
if (arr.Length == 10)
{
    path = "C:\\Users\\rgunn\\Desktop\\" + arr[0] + arr[1] + "-" + arr[3] + arr[4] + "-" + arr[8] + arr[9] + ".txt";
}
